    ...
    let(:expected) do
      {
        ...
        'license' => { 'key' => 'mit', 'name' => 'MIT License', 'node_id' => 'MDc6TGljZW5zZTEz', 'spdx_id' => 'MIT',
        ...
        'organization' => { 'avatar_url' => 'https://avatars.githubusercontent.com/u/6128107?v=4',
                            'events_url' => 'https://api.github.com/users/vuejs/events{/privacy}', 'followers_url' => 'https://api.github.com/users/vuejs/followers', 'following_url' => 'https://api.github.com/users/vuejs/following{/other_user}', 'gists_url' => 'https://api.github.com/users/vuejs/gists{/gist_id}', 'gravatar_id' => '', 'html_url' => 'https://github.com/vuejs', 'id' => 6_128_107, 'login' => 'vuejs', 'node_id' => 'MDEyOk9yZ2FuaXphdGlvbjYxMjgxMDc=', 'organizations_url' => 'https://api.github.com/users/vuejs/orgs', 'received_events_url' => 'https://api.github.com/users/vuejs/received_events', 'repos_url' => 'https://api.github.com/users/vuejs/repos', 'site_admin' => false, 'starred_url' => 'https://api.github.com/users/vuejs/starred{/owner}{/repo}', 'subscriptions_url' => 'https://api.github.com/users/vuejs/subscriptions', 'type' => 'Organization', 'url' => 'https://api.github.com/users/vuejs' },
